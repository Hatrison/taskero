"use strict";(self.webpackChunktaskero=self.webpackChunktaskero||[]).push([[583],{988:(e,t,r)=>{r.d(t,{hX:()=>i,pU:()=>o,ph:()=>n});const i=e=>e.projects.items,n=e=>e.projects.current,o=e=>e.projects.loading},3583:(e,t,r)=>{r.r(t),r.d(t,{default:()=>yt});var i=r(5043),n=r(5180),o=r(4961),s=r(2115),l=r(9867),a=r(3289),d=r(9006),c=r(988);const h=e=>e.columns.items,m=e=>e.tasks.items;var p=r(2246),u=r(9593),x=r(7784),j=r(3892),g=r(7142),f=r(7606),y=r(7711),b=r(5464);const v=b.Ay.div`
  display: flex;
...
//# sourceMappingURL=583.a0992102.chunk.js.map