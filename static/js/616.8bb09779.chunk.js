...
`,q=y.Ay.div`
  ...
  background-color: ${e=>{let{theme:r}=e;return r.background}};
  overflow: hidden;
`;var G=t(9581),D=t(26),H=t(3367),K=t(551),X=t(7950),Z=t(3903);const Q=y.Ay.input`
  width: 100%;
  padding: 12px;
  font-size: 16px;
...
`,_e=y.Ay.div`
  ...
  height: 100%;
  gap: 24px;
`,Re=e=>{var r;let{columns:t,topOffset:o=24,withActions:a=!1,onEditOrder:d}=e;const h=(0,l.jL)(),p=null===(r=(0,l.GV)(c.ph))||void 0===r?void 0:r._id,[m,u]=(0,i.useState)(!1),{t:x}=(0,n.B)(),j=()=>[...t].sort(((e,r)=>e.order-r.order));return(0,A.jsxs)(Se,{children:[a&&(0,A.jsx)(Pe,{type:"button",topOffset:o+24,"data-active":m,onClick:()=>{u((e=>!e)),null===d||void 0===d||d()},children:(0,A.jsx)(Me.p92,{size:20})}),(0,A.jsxs)(ge.JY,{onDragEnd:async e=>{const{source:r,destination:i,draggableId:o,type:n}=e;if(i)if("column"!==n){if("task"===n){if(r.droppableId===i.droppableId&&r.index===i.index)return;const n=t.find((e=>e._id===r.droppableId)),l=null===n||void 0===n?void 0:n.tasks.find((e=>e._id===o));if(!l)return;const a=new FormData;return a.append("column",i.droppableId),void h((0,D.lC)({id:e.draggableId,formData:a})).unwrap().catch((e=>{s.oR.error(`${x("Project.columns.moveTaskFailed")}: ${e.message}`)}))}}else{if(!m||r.index===i.index)return;const e=[...j()],[t]=e.splice(r.index,1);e.splice(i.index,0,t);const o=e.map(((e,r)=>({id:e._id,order:r})));h((0,G.Fh)({columns:o})).unwrap().catch((e=>{s.oR.error(`${x("Project.columns.reorderFailed")}: ${e.message}`)}))}},children:[m&&a?(0,A.jsx)(ge.gL,{droppableId:"columns",direction:"horizontal",type:"column",children:e=>(0,A.jsxs)(_e,{ref:e.innerRef,...e.droppableProps,children:[j().map(((e,r)=>(0,A.jsx)(ge.sx,{draggableId:e._id,index:r,children:r=>(0,A.jsx)("div",{ref:r.innerRef,...r.draggableProps,...r.dragHandleProps,children:(0,A.jsx)(Fe,{column:e,withActions:a,isEditable:m})})},e._id))),e.placeholder]})}):(0,A.jsx)(_e,{children:j().map((e=>(0,A.jsx)(Fe,{column:e,withActions:a},e._id)))}),m&&(0,A.jsx)(Fe,{isEmpty:!0,withActions:a,onClickEmpty:()=>{if(p)try{const e={name:x("Project.columns.newColumn"),order:t.length,project:p};h((0,G.HA)(e))}catch(e){s.oR.error(`${x("Project.columns.addFailed")}: ${e instanceof Error?e.message:String(e)}`)}}})]})]})},Ee=()=>{const{id:e}=(0,o.g)(),r=(0,o.Zp)(),t=(0,l.jL)(),u=(0,l.GV)(a.mB),x=(0,l.GV)(c.ph),j=(0,l.GV)(c.pU),g=(0,l.GV)(h),f=(0,l.GV)(p),y=(0,i.useRef)(null),[v,b]=(0,i.useState)(0),[w,k]=(0,i.useState)(!1),[C,T]=(0,i.useState)(!1),[F,S]=(0,i.useState)(!1),[P,_]=(0,i.useState)(!1),{t:R}=(0,n.B)();(0,i.useEffect)((()=>{if(!y.current)return;const e=new ResizeObserver((e=>{for(let r of e)b(r.contentRect.height)}));return e.observe(y.current),()=>e.disconnect()}),[]),(0,i.useEffect)((()=>{e&&t((0,d.kf)(e))}),[t,e]),(0,i.useEffect)((()=>{var e,r;const t=(null===x||void 0===x||null===(e=x.members)||void 0===e?void 0:e.filter((e=>"owner"===e.role)).map((e=>e.user._id)))||[],i=(null===x||void 0===x||null===(r=x.members)||void 0===r?void 0:r.filter((e=>"editor"===e.role)).map((e=>e.user._id)))||[],o=t.includes(u._id),n=i.includes(u._id);S(o),_(o||n)}),[u,x]);const E=()=>{k((e=>!e))},z=()=>{T((e=>!e))},I=f.reduce(((e,r)=>(e[r.column]||(e[r.column]=[]),e[r.column].push(r),e)),{});return(0,A.jsxs)(V,{children:[(0,A.jsx)("div",{ref:y,children:(0,A.jsx)(N,{name:(null===x||void 0===x?void 0:x.name)||"",avatar:u.avatar,toggleMembersModal:E,toggleSettingsModal:z})}),j?(0,A.jsx)(O,{children:(0,A.jsx)(m.A,{size:"60px",color:"#3e85f3"})}):(0,A.jsx)(q,{children:(0,A.jsx)(Re,{columns:g.map((e=>({...e,tasks:I[e._id]||[]}))),topOffset:v,withActions:P})}),w&&(0,A.jsx)($,{handlerCloseModal:()=>E(),projectId:e||"",withActions:F}),C&&(0,A.jsx)(M,{handlerCloseModal:()=>z(),deleteAction:()=>(async()=>{if(e&&x)try{await t((0,d.xx)(x._id)),s.oR.success(R("Forms.deleteProject.success")),z(),r("/",{replace:!0})}catch(i){s.oR.error(`${R("Forms.deleteProject.failed")}: ${i instanceof Error?i.message:String(i)}`)}})(),withActions:F})]})}}}]);
//# sourceMappingURL=616.8bb09779.chunk.js.map