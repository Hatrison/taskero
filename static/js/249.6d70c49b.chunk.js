...
`,k=p.Ay.p`
  ...
  color: ${e=>{let{theme:r}=e;return r.secondaryText}};
  margin-left: auto;
`;var A=t(579);const C=e=>{let{project:r,role:t}=e;const{name:o,company:i,members:l,createdAt:a}=r,{i18n:d,t:s}=(0,n.B)(),c=(0,p.DP)(),g={en:h.c,uk:m.uk}[d.language]||h.c,C={owner:c.roleOwner,editor:c.roleEditor,viewer:c.roleViewer};return(0,A.jsxs)(y,{to:`/projects/${r._id}`,children:[(0,A.jsxs)(b,{children:[(0,A.jsx)(f,{children:o}),(0,A.jsx)(j,{children:i.name})]}),(0,A.jsxs)(v,{children:[(0,A.jsx)(x.A,{members:[...l.map((e=>{let{user:r}=e;return r}))].reverse()}),(0,A.jsxs)($,{children:[t&&(0,A.jsx)(w,{color:C[t],children:s(`Projects.filters.${t.charAt(0).toUpperCase()+t.slice(1)}`)}),(0,A.jsx)(k,{children:(0,u.GP)(new Date(a),"dd MMM yyyy",{locale:g})})]})]})]})};var z=t(551),P=t(9593),M=t(7784),T=t(3892),L=t(2115),B=t(899);const E=B.Ik({name:B.Yj().min(2).max(100).required("Required"),description:B.Yj().max(1e3),deadline:B.p6().nullable()});var _=t(7711);const F={name:"",description:"",deadline:""},S=e=>{let{handlerCloseModal:r,formName:t}=e;const{t:o}=(0,n.B)(),d=(0,i.jL)(),c=(0,i.GV)(l.jt),p=(0,i.GV)(s.mB);return(0,A.jsx)(T.l1,{initialValues:F,validationSchema:E,onSubmit:async e=>{if(null===c||void 0===c||!c._id||null===p||void 0===p||!p.email)return void L.oR.error(o("Forms.createProject.failed"));const t={...e,company:c._id,members:[{email:p.email,role:"owner"}]};try{await d((0,a.gA)(t)).unwrap(),L.oR.success(o("Forms.createProject.success")),r()}catch(n){L.oR.error(`${o("Forms.createProject.failed")}: ${n instanceof Error?n.message:String(n)}`)}},children:e=>{let{values:r,errors:n,touched:i,handleChange:l,handleBlur:a}=e;return(0,A.jsxs)(_.q,{id:t,children:[(0,A.jsxs)(_.A0,{children:[(0,A.jsx)(_.JU,{children:o("Forms.createProject.name")}),(0,A.jsx)(_.pd,{name:"name",placeholder:o("Forms.createProject.namePlaceholder"),$hasError:i.name&&!!n.name}),i.name&&n.name&&(0,A.jsx)(_.yn,{children:n.name})]}),(0,A.jsxs)(_.A0,{children:[(0,A.jsx)(_.JU,{children:o("Forms.createProject.description")}),(0,A.jsx)(_.TM,{name:"description",placeholder:o("Forms.createProject.descriptionPlaceholder"),value:r.description,onChange:l,onBlur:a,$hasError:i.description&&!!n.description}),i.description&&n.description&&(0,A.jsx)(_.yn,{children:n.description})]}),(0,A.jsxs)(_.A0,{children:[(0,A.jsx)(_.JU,{children:o("Forms.createProject.deadline")}),(0,A.jsx)(_.pd,{name:"deadline",type:"date"})]})]})}})},V=e=>{let{handlerCloseModal:r}=e;const{t:t}=(0,n.B)(),o="create-project-form";return(0,A.jsx)(P.A,{handlerCloseModal:r,children:(0,A.jsx)(M.A,{handlerCloseModal:r,title:t("Modals.createProject.title"),formName:o,children:(0,A.jsx)(S,{handlerCloseModal:r,formName:o})})})},G=p.Ay.div`
  padding: 24px;
  display: flex;
  flex-direction: column;
  gap: 48px;
...
`,I=p.Ay.div`
  ...
  gap: 16px;
`,J=()=>{const e=(0,i.jL)(),[r,t]=(0,o.useState)(""),[p,u]=(0,o.useState)("All Projects"),[h,m]=(0,o.useState)(!1),x=(0,i.GV)(d.pU),g=(0,i.GV)(l.jt),y=(0,i.GV)(d.hX),b=(0,i.GV)(s.AS),{t:f}=(0,n.B)();(0,o.useEffect)((()=>{e((0,a.ZH)())}),[e]);const j=()=>{m((e=>!e))},v=(0,o.useMemo)((()=>y.map((e=>{var r;const t=null===(r=e.members.find((e=>e.user.email===b)))||void 0===r?void 0:r.role;return{project:e,role:t}})).filter((e=>{let{project:t,role:o}=e;const n=t.company._id===(null===g||void 0===g?void 0:g._id),i=t.name.toLowerCase().includes(r.toLowerCase()),l="All Projects"===p,a=(null===o||void 0===o?void 0:o.toLowerCase())===p.toLowerCase();return n&&i&&(l||a)}))),[y,null===g||void 0===g?void 0:g._id,b,r,p]);return(0,A.jsx)(G,{children:x?(0,A.jsx)(N,{children:(0,A.jsx)(c.A,{size:"48px",color:"#3e85f3"})}):(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(H,{children:[(0,A.jsxs)(U,{children:[(0,A.jsx)(q,{children:f("Projects.title")}),(0,A.jsx)(O,{onClick:()=>{j()},children:f("Projects.create")})]}),(0,A.jsxs)(R,{children:[(0,A.jsx)(X,{type:"text",placeholder:f("Projects.searchPlaceholder"),value:r,onChange:e=>t(e.target.value)}),(0,A.jsx)(D,{children:(0,A.jsx)(z.A,{options:["All Projects","Owner","Editor","Viewer"],value:p,onChange:u,getLabel:e=>f(`Projects.filters.${e}`),getKey:e=>e})})]})]}),(0,A.jsx)(I,{children:v.map((e=>{let{project:r,role:t}=e;return(0,A.jsx)(C,{project:r,role:t},r._id)}))}),h&&(0,A.jsx)(V,{handlerCloseModal:j})]})})}},7711:(e,r,t)=>{t.d(r,{A0:()=>d,GX:()=>y,Gg:()=>h,JU:()=>s,K_:()=>u,N3:()=>f,TM:()=>$,ZD:()=>m,b7:()=>g,mO:()=>l,oX:()=>v,oi:()=>p,pd:()=>c,q:()=>a,ql:()=>x,sF:()=>b,yn:()=>j});var o=t(5464),n=t(3892),i=t(5180);const l=o.Ay.div`
  width: 100%;
`,a=(0,o.Ay)(n.lV)`
  display: flex;
  flex-direction: column;
...
//# sourceMappingURL=249.6d70c49b.chunk.js.map