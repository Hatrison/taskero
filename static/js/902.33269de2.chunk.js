...
`;var s=t(5043),d=t(3892),c=t(2115),u=t(9867),p=t(7201),m=t(3289),h=t(2246),x=t(184),b=t(899);const g=b.Ik().shape({fullName:b.Yj().required("Required"),email:b.Yj().email().required("Required"),avatarFile:b.gl().nullable()});var w=t(7711);const f=n.Ay.div`
  display: flex;
...
`,j=(0,o.Ay)(c).attrs({as:"textarea"})`
  ...
  height: 150px;
  overflow-y: auto;
`},7784:(e,r,t)=>{t.d(r,{A:()=>k});var o,n,a=t(5043),i=t(4961),l=t(5464),s=t(2246),d=t(5735),c=t(7711);function u(){return u=Object.assign?Object.assign.bind():function(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var o in t)({}).hasOwnProperty.call(t,o)&&(e[o]=t[o])}return e},u.apply(null,arguments)}function p(e,r){let{title:t,titleId:i,...l}=e;return a.createElement("svg",u({xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",ref:r,"aria-labelledby":i},l),t?a.createElement("title",{id:i},t):null,o||(o=a.createElement("path",{d:"M18 6L6 18",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})),n||(n=a.createElement("path",{d:"M6 6L18 18",strokeWidth:2,strokeLinecap:"round",strokeLinejoin:"round"})))}const m=a.forwardRef(p),h=(t.p,l.Ay.div`
  display: flex;
  flex-direction: column;
  width: 100%;
`),x=l.Ay.div`
...
`;var j=t(579);const k=e=>{let{handlerCloseModal:r,title:t,formName:o,deleteAction:n,withActions:u=!0,children:p}=e;const[m,k]=(0,a.useState)(!1),$=(0,a.useMemo)((()=>({setModalSubmitting:k})),[]),{t:A}=(0,i.B)(),P=(0,l.DP)();return(0,j.jsx)(d.l.Provider,{value:$,children:(0,j.jsxs)(h,{children:[(0,j.jsxs)(x,{children:[(0,j.jsx)(w,{children:t}),(0,j.jsx)(b,{onClick:r,children:(0,j.jsx)(g,{})})]}),(0,j.jsx)(f,{children:p}),u&&(0,j.jsxs)(y,{children:[n&&(0,j.jsx)(c.N3,{type:"button",onClick:()=>n(),children:A("Modals.common.delete")}),(0,j.jsxs)(v,{children:[(0,j.jsx)(c.sF,{type:"button",onClick:r,children:A("Modals.common.cancel")}),(0,j.jsxs)(c.GX,{type:"submit",form:o,disabled:m,children:[(0,j.jsx)("span",{className:"btn-text",children:A("Modals.common.save")}),m&&(0,j.jsx)("div",{className:"btn-loader",children:(0,j.jsx)(s.A,{size:"16px",color:P.buttonText})})]})]})]})]})})}},9593:(e,r,t)=>{t.d(r,{A:()=>c});var o=t(5043),n=t(7950),a=t(5464);const i=a.Ay.div`
